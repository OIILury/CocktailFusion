...
) -> Result<crate::models::InlineResponse2001, Error<GetVersionError>> {
...
pub async fn is_alive(
    configuration: &configuration::Configuration,
) -> Result<crate::models::InlineResponse200, Error<IsAliveError>> {
    let local_var_client = &configuration.client;
...
pub async fn is_ready(
    configuration: &configuration::Configuration,
) -> Result<crate::models::InlineResponse200, Error<IsReadyError>> {
    let local_var_client = &configuration.client;
